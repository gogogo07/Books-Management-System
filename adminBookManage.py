...
"")
        ...
        self.adminBookFindBtn.setGeometry(QtCore.QRect(290, 12, 35, 30))
        self.adminBookFindBtn.setText("")
        ...
        adminBookManage.setTabOrder(self.adminBookFindEdit, self.adminBookFindBtn)
        adminBookManage.setTabOrder(self.adminBookFindBtn, self.comboBox)
        adminBookManage.setTabOrder(self.comboBox, self.adminBookTableWidget)
        adminBookManage.setTabOrder(self.adminBookTableWidget, self.adminBookSoldBtn)
        adminBookManage.setTabOrder(self.adminBookSoldBtn, self.adminBookBackBtn)
