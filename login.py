...
class Ui_loginWidgrt(object):
    def setupUi(self, loginWidgrt):
        loginWidgrt.setObjectName("loginWidgrt")
        loginWidgrt.resize(472, 284)
        loginWidgrt.setStyleSheet("/*\n"
"* The MIT License (MIT)\n"
"*\n"
...
"}\n"
"")
        self.pushButton = QtWidgets.QPushButton(loginWidgrt)
        self.pushButton.setGeometry(QtCore.QRect(60, 220, 75, 23))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(loginWidgrt)
        self.pushButton_2.setGeometry(QtCore.QRect(330, 220, 75, 23))
        self.pushButton_2.setObjectName("pushButton_2")
        self.lineEdit = QtWidgets.QLineEdit(loginWidgrt)
        self.lineEdit.setGeometry(QtCore.QRect(190, 50, 161, 21))
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit_2 = QtWidgets.QLineEdit(loginWidgrt)
        self.lineEdit_2.setGeometry(QtCore.QRect(190, 140, 161, 21))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.label = QtWidgets.QLabel(loginWidgrt)
        self.label.setGeometry(QtCore.QRect(80, 50, 54, 12))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(loginWidgrt)
        self.label_2.setGeometry(QtCore.QRect(80, 150, 54, 12))
        self.label_2.setObjectName("label_2")

        self.retranslateUi(loginWidgrt)
        self.pushButton.clicked.connect(loginWidgrt.login)
        self.pushButton_2.clicked.connect(loginWidgrt.register123)
        QtCore.QMetaObject.connectSlotsByName(loginWidgrt)

    def retranslateUi(self, loginWidgrt):
        _translate = QtCore.QCoreApplication.translate
        loginWidgrt.setWindowTitle(_translate("loginWidgrt", "Form"))
        self.pushButton.setText(_translate("loginWidgrt", "登陆"))
        self.pushButton_2.setText(_translate("loginWidgrt", "注册"))
        self.label.setText(_translate("loginWidgrt", "账号"))
        self.label_2.setText(_translate("loginWidgrt", "密码"))
