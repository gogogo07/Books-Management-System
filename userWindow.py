...
"")
        ...
        self.userExitBtn.clicked.connect(userWindow.userExit)
        self.userBorrowBtn.clicked.connect(userWindow.userBorrow)
        self.userBookRecBtn.clicked.connect(userWindow.userBookRecommend)
        self.userHotBtn.clicked.connect(userWindow.userHotBooks)
        self.userFindBtn.clicked.connect(userWindow.userFind)
        QtCore.QMetaObject.connectSlotsByName(userWindow)
        userWindow.setTabOrder(self.bookNameEdit, self.userFindBtn)
        userWindow.setTabOrder(self.userFindBtn, self.userHotBtn)
        userWindow.setTabOrder(self.userHotBtn, self.userBookRecBtn)
        userWindow.setTabOrder(self.userBookRecBtn, self.userRecordBtn)
        userWindow.setTabOrder(self.userRecordBtn, self.userExitBtn)
        userWindow.setTabOrder(self.userExitBtn, self.userTableWidget)
        userWindow.setTabOrder(self.userTableWidget, self.kindofBooksBox)

    def retranslateUi(self, userWindow):
        _translate = QtCore.QCoreApplication.translate
        userWindow.setWindowTitle(_translate("userWindow", "图书管理系统"))
        self.userHotBtn.setText(_translate("userWindow", "当前热门"))
        self.userRecordBtn.setText(_translate("userWindow", "我的记录"))
        self.userBookRecBtn.setText(_translate("userWindow", "猜你喜欢"))
        item = self.userTableWidget.horizontalHeaderItem(0)
        item.setText(_translate("userWindow", "图书名称"))
        item = self.userTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("userWindow", "作者"))
        item = self.userTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("userWindow", "分类"))
        item = self.userTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("userWindow", "编号"))
        item = self.userTableWidget.horizontalHeaderItem(4)
        item.setText(_translate("userWindow", "剩余图书量"))
        item = self.userTableWidget.horizontalHeaderItem(5)
        item.setText(_translate("userWindow", "已借出次数"))
        self.userExitBtn.setText(_translate("userWindow", "退出"))
        self.userBorrowBtn.setText(_translate("userWindow", "借阅"))
        self.kindofBooksBox.setItemText(0, _translate("userWindow", "全部分类"))
        self.kindofBooksBox.setItemText(1, _translate("userWindow", "自传"))
        self.kindofBooksBox.setItemText(2, _translate("userWindow", "医学"))
        self.kindofBooksBox.setItemText(3, _translate("userWindow", "文学"))
        self.kindofBooksBox.setItemText(4, _translate("userWindow", "计算机"))
        self.userFindBtn.setText(_translate("userWindow", "查询"))
